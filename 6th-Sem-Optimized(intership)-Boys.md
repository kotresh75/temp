# Optimized Internship Calendar with Tasks - Boys

### Summary
* **Total Calendar Days:** 111 Days (15/12/2025 - 04/04/2026)
...
| :--- | :--- | :--- | :--- | :--- |
| 15/12/2025 | Monday | Day 1 | Orientation & Introduction | Reached the office. Attended the HR orientation, received the intern ID card, and met the assigned mentor. |
| 16/12/2025 | Tuesday | Day 2 | Desk Setup & Software Installation | Set up the physical desk. Guided by the mentor to install necessary tools: VS Code, Google Chrome, Node.js, and Git. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 29/12/2025 | Monday | Day 10 | Variables & Data Types | Reviewed let, const, and basic data types. Wrote simple scripts to manipulate strings and arrays. |
| 30/12/2025 | Tuesday | Day 11 | Functions & Arrow Syntax | Practiced writing standard functions and converting them into ES6 arrow functions. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 05/01/2026 | Monday | Day 15 | What is React? | Shadowed a frontend developer who explained the concept of the Virtual DOM. |
| 06/01/2026 | Tuesday | Day 16 | Setting up React (Vite) | Guided by a junior dev to set up a new React project using Vite. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 19/01/2026 | Monday | Day 24 | Client-Server Architecture | Attended a whiteboard session outlining how React frontend talks to Node.js backend. |
| 20/01/2026 | Tuesday | Day 25 | Node Setup & npm | Initialized a new Node.js project. Learned how to install external packages using npm. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 02/02/2026 | Monday | Day 33 | Relational vs. NoSQL | Read assigned articles explaining the difference between SQL tables and MongoDB documents. |
| 03/02/2026 | Tuesday | Day 34 | MongoDB Compass Setup | Installed MongoDB Compass and connected to the company dedicated local intern database. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 09/02/2026 | Monday | Day 38 | Implementing the GET Route (DB) | Updated the GET route to use Employee.find() to return real data from database. |
| 10/02/2026 | Tuesday | Day 39 | Implementing the POST Route (DB) | Updated the POST route to create and save a new Employee document to MongoDB. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 16/02/2026 | Monday | Day 43 | Understanding CORS | Encountered and resolved the CORS error when trying to fetch data from React. |
| 17/02/2026 | Tuesday | Day 44 | Using useEffect for Data Fetching | Added a useEffect hook to automatically call the local GET API when page loads. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 23/02/2026 | Monday | Day 48 | CSS Frameworks Overview | Explored Bootstrap and TailwindCSS documentations. Decided on framework based on mentor recommendation. |
| 24/02/2026 | Tuesday | Day 49 | Integrating the Framework | Installed and configured the chosen CSS framework within the React project. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 02/03/2026 | Monday | Day 53 | Project Briefing | Met with the engineering manager to discuss a simple internal tool project. |
| 03/03/2026 | Tuesday | Day 54 | Schema Planning | Sat with the mentor to draw the necessary database schema on a whiteboard. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 09/03/2026 | Monday | Day 58 | Building the API Routes | Focused entirely on the backend, writing the CRUD routes for the primary resource. |
| 10/03/2026 | Tuesday | Day 59 | Testing the API | Thoroughly tested all new endpoints using Postman. |
...
| Date | Day | Status | Task | Description |
| :--- | :--- | :--- | :--- | :--- |
| 23/03/2026 | Monday | Day 67 | Writing the Project Report (Intro) | Drafted the introduction, objective, and software/hardware requirements section. |
| 24/03/2026 | Tuesday | Day 68 | Documenting the Architecture | Created simple diagrams showing frontend-backend-database interaction. |
...
**Submission Date: 06/04/2026 (Monday)** - Final report and project submission
